...
const Transfer = (props) => {
    return (
        <div className="transferContainer">
            ...
            <p style={{fontFamily:"Poppins", fontSize: "20px"}}>Transfer to</p>
            <input type="textbox" className='transferInput'/>
            <p style={{fontFamily:"Poppins", fontSize: "20px"}}>Amount</p>
            <input type="textbox" className='transferInput'/>
            <p style={{fontFamily:"Poppins", fontSize: "20px"}}>Your Pin</p>
